...
// B. Menu After Manger --> Engineer Input
const menuManEngInput = [

    {
        type: 'list',
        name: 'afterMEInfo',
        message: 'What do you want to do next?',
        choices: ["Add Intern", "The Team is finished"]
    }

]

// C. Menu After Manger --> Intern Input
const menuManIntInput = [

    {
        type: 'list',
        name: 'afterMIInfo',
        message: 'What do you want to do next?',
        choices: ["Add Engineer", "The Team is finished"]
    }
